            ...
            items.push(`
                <div class="launcher-notice rounded-2xl p-4 md:p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <div class="text-sm text-white/45 mt-1">${updateSummaryCopy}</div>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    ` : !syncEnabled ? `
                        <div class="mt-4 rounded-2xl border border-white/10 bg-white/5 p-4 md:p-5">
                            ...
                            <div class="text-sm text-white/45 mt-1">No public catalog publish target is configured for this deployment.</div>
                        </div>
                    ` : ''}
                    ${updateCount > 0 ? `
